...
test('settings expose language, independent scale and close policy', () => {
  for (const token of ['Interface e idioma','Usar idioma do Windows','80','150','Perguntar sempre','Minimizar para a bandeja','Português (Brasil)','English','Español','Français','Deutsch','Italiano']) {
